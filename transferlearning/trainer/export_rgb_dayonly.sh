...
# Actual call
CUDA_VISIBLE_DEVICES=0,1,2 python3 object_detection/export_inference_graph.py \
    ...
    --output_directory /media/sdc/andya/wormhole_learning/models/obj_detector_retrain/$job_name/