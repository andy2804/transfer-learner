...
def run_conversion(flags):
    files = read_filenames(flags.dataset_dir, 'visible', 'lwir', 'png')
    ...
    # Initialize filter
    learning_filter = TFRecordLearningFilter(min_img_perimeter=flags.min_obj_size,
                                             logstats=True,
                                             verbose=False)
...
def _mean_n_var_from_dataset(files):
    ...
    :param files:
    :return: mean value and standart deviation
    """
    # todo which format?
