...
from objdetection.ir2rgb.tfrecords_builder.builder_tfrecords import run_conversion

flags = tf.flags
FLAGS = flags.FLAGS

# ================ LABELS
flags.DEFINE_string('labels_net', 'kaist_label_map.json',
...
flags.DEFINE_string('tfrecord_name_prefix', "KAIST_TRAINING_NIGHT_rgb035_from_ir065",
